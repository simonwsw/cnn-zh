...
def gnt2pickle():
    ...
    train_gnt_files.load_file("data/l_train_pickle", "train", 500, 0, 300)

    # valid set data
    valid_gnt_files = GntFiles("data/valid_set")
    valid_gnt_files.load_file("data/l_valid_pickle", "valid", 500, 0, 300)

    # test set data
    test_gnt_files = GntFiles("data/test_set")
    test_gnt_files.load_file("data/l_test_pickle", "test", 500, 0, 300)
